...
public class ItemAdapter_Team extends RecyclerView.Adapter<ItemAdapter_Team.ItemViewHolder> {
    ...
    public ItemAdapter_Team(List<DataModel> mList){
        this.mList  = mList;
    }
    @NonNull
    @Override
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.each_item_team_volunteer, parent , false);
...
//pass Teamname to the NestedAdapter class to delete particular item from database also pass 2 for team class and 1 for editTeam
        NestedAdapter_Team adapter = new NestedAdapter_Team(list,TeamName);
